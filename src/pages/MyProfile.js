            ...
            <div className="container-xl pt-5 profile_data_before_md_srcn">
                <div className="row px-3">
                    <div className="col-md-3 col-lg-2 dashboard_left_side">
                        ...
                        <Link to="/my_profile/emails" style={{ textDecoration: "none", color: "black" }}><h5 className="py-2 sub_heading text-dark"><i class="fa fa-envelope"></i> Emails</h5></Link>
                        <Link to="/" style={{ textDecoration: "none", color: "black" }}><h5 className="py-2 sub_heading text-dark"><i class="fa fa-gear"></i> Setting</h5></Link>
                    </div>
