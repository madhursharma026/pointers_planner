        ...
        <>
            ...
            <div className="compose_email mt-5">
                <div className="bg-dark">
                    <p className='text-light p-2' style={{ fontSize: "20px" }}>&ensp;<i class="fa fa-commenting"></i>&emsp; Send to johndoe123@gmail.com</p>
                </div>
                ...
                <button type="button" class="btn" style={{ float: "right", background: "#EFECCE", fontSize: "18px" }}><b>Send Emails</b></button>
            </div>
        </>
    );
}
